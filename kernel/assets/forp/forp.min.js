...
{if(typeof(mixed)=='object'){return f.wrap(mixed);}else{return new f.DOMElementWrapperCollection(document.querySelectorAll(mixed));}},ready:function(callback){/*@cc_on
            @if (@_win32 || @_win64)
...
for(t in transitions){if(el.style[t]!==undefined){return transitions[t];}}}},SortedFixedArray:function(compare,size){this.stack=[];this.size=size;this.insert=function(entry,i){for(var j=Math.min(this.size-1,this.stack.length);j>i;j--){this.stack[j]=this.stack[j-1];}
this.stack[i]=entry;}
...
{f.DOMElementWrapper.call(this);this.element=document.createElement("div");this.class("backtrace").attr("style","text-align: center");this.prependItem=function(entry,highlight){return this.prepend(f.create("div").class("backtrace-item "+(highlight?" highlight":"")).text("<strong>"+entry.id+"</strong><br>"+
entry.filelineno+"<br>"+
...
{if(!descendant.parent)return;this.stack[descendant.parent].usec-=value;this.refineParents(this.stack[descendant.parent],value);return this;};this.aggregate=function()
...
f.create('style').text('#forp{position:fixed !important;bottom:0px !important;right:0px !important;color:#222 !important;z-index:2147483647 !important;text-decoration:none !important;font-family:Segoe UI,"Helvetica Neue",Helvetica,Nimbus,Arial,sans-serif !important;font-weight:300 !important;text-rendering:optimizelegibility !important;max-width:300px !important;font-size:13px !important;background:#fff !important;line-height:1.3 !important}#forp *{color:#252121 !important}#forp div.footer{height:5px !important;position:absolute !important;top:0px !important;left:0px !important;right:0px !important;background-color:#fcfcfc !important}#forp.embeddedCompacted{margin:15px !important;width:200px !important;opacity:.6 !important;cursor:pointer !important}#forp.embeddedCompacted:hover{opacity:1 !important}#forp.embeddedCompacted nav{height:auto !important}#forp.embeddedCompacted nav>div{margin:3px 0px !important}#forp.embeddedExpanded,#forp.standalone{min-width:1000px !important;max-width:100% !important;left:0px !important}#forp.embeddedExpanded a,#forp.standalone a{display:inline}#forp.embeddedExpanded nav,#forp.standalone nav{height:auto !important;line-height:22px !important}#forp.embeddedExpanded nav>div,#forp.standalone nav>div{float:left}#forp nav{background:#fcfcfc !important;padding:10px 10px 5px 10px !important;line-height:1 !important;width:100% !important;float:left !important;}#forp a{white-space:nowrap !important;text-decoration:none !important;color:#FFF !important}#forp a.btn,a.tbtn{color:#FFF;margin:0px 5px;padding:4px 5px 5px 5px;background:#555;text-decoration:none}#forp div.close{color:#ccc !important;padding:5px 10px !important;position:absolute !important;top:5px !important;right:30px !important;text-align:center !important}#forp div.close:hover{cursor:pointer;color:#555}#forp .highlight{background:#4d90fe !important;color:#FFF !important}#forp a.tag{background:#EE0 !important;color:#222 !important;font-size:10px !important;padding:2px 5px !important;margin:0px 5px !important}#forp a.tag,#forp a{border-radius:3px !important}#forp div.backtrace{color:#aaa !important}#forp div.backtrace-item{color:#333 !important;margin:0px 5px !important;padding:4px 5px 5px 5px !important;background:#eee !important;text-decoration:none !important;border-radius:8px !important;padding:5px !important;display:inline-block !important}#forp.shadow{-moz-box-shadow:0 0 8px #ccc !important;-webkit-box-shadow:0 0 8px #ccc !important;box-shadow:0 0 8px #ccc !important}#forp table{font-weight:300 !important;font-size:13px !important;width:100% !important;border-collapse:collapse !important}#forp div.panel{overflow:auto !important;overflow-x:hidden !important;transition:height .1s !important;-moz-transition:height .1s !important;-webkit-transition:height .1s !important}#forp div.mainpanel{border-top:1px solid #BBB !important;float:left !important;width:100% !important}#forp div.console{position:relative !important;float:left !important;background:#fff !important;width:100% !important}#forp div.sidebar{float:right !important}#forp th,#forp td{padding:5px !important;border:1px solid #ddd !important}#forp th{text-align:center !important;font-weight:bold !important;color:#333 !important;border:1px solid #ddd !important;background:#eee !important}#forp .w100{width:110px !important}#forp td{text-align:left !important;text-overflow:ellipsis !important;word-space:nowrap !important;overflow:hidden !important;vertical-align:top !important}#forp tr{color:#333 !important;background:#fff !important}#forp tr.sub{background:#eee !important}#forp tr:hover{background:#edf4ff !important}#forp tr[data-ref]{cursor:pointer !important}#forp .numeric{text-align:right !important}#forp ul{line-height:1.8 !important;list-style:none !important;padding-left:20px !important}#forp ul.l0{padding-left:10px !important}#forp li{line-height:1.8 !important}#forp li>div.numeric{min-width:60px !important;margin:0px 10px !important}#forp div.expander{text-align:center !important;width:20px !important;cursor:pointer !important}#forp li.expanded>div.expander:before{content:"-" !important}#forp li.collapsed>div.expander:before{content:"+" !important}#forp li.collapsed>ul{display:none !important}#forp .left{float:left !important}#forp .right{float:right !important}#forp div.gauge{position:relative !important;background:#eee !important;color:#333 !important;margin:4px 5px 0px 0px !important;width:110px !important;text-align:right !important;font-size:0.8em !important}#forp div.gauge div.bar{background:#59f !important;height:18px !important}#forp div.gauge div.text{position:absolute !important;top:0px !important;right:4px !important;line-height:1.8 !important}#forp td>div.gauge{margin:0px !important}#forp input[type=text],#forp input[type=text]:hover{border:0 none !important;font-size:11px !important;padding:5px !important;border:1px solid #777 !important;border-radius:3px !important;background:#fff !important;margin:0px 5px !important;height:auto !important;width:auto !important}#forp .indent{padding-left:30px !important}#forp div.w2of3{width:66% !important}#forp div.w1of3{width:33% !important}#forp div.grade,#forp div.grade-A,#forp div.grade-B,#forp div.grade-C,#forp div.grade-D,#forp div.grade-E{padding:2px 5px !important;display:inline-block !important;border-radius:3px !important;font-size:.8em !important;color:#FFF !important}#forp div.grade-A{background-color:#9E5 !important}#forp div.grade-B{background-color:#EE5 !important}#forp div.grade-C{background-color:#EB5 !important}#forp div.grade-D{background-color:#E95 !important}#forp div.grade-E{background-color:#E55 !important}').appendTo(new f.DOMElementWrapper(styleTarget));self.getStack().aggregate();if(this.viewMode=="embeddedCompacted"){this.getLayout().compact(this.onCompact);}else if(this.viewMode=="standalone"){this.open();}}catch(e)
